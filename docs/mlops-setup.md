...
[ML Config](../ulta_mlops_demo/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore ulta_mlops_demo/resources/README.md
...
Follow the instructions in [ulta_mlops_demo/resources/README.md](../ulta_mlops_demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../ulta_mlops_demo/resources/README.md)  to propose, test, and deploy
